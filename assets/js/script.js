  ...
  if ($(".tabs-box").length) {
    $(".tabs-box .tab-buttons .tab-btn").on("click", function (e) {
      ...
      if ($(target).is(":visible")) {
        return false; // Exit if the target tab is already visible
      }
      ...
      // Remove active-tab class from all tabs and hide their content-box
      target
        .parents(".tabs-box")
      ...
      // Add active-tab class to the target tab and show its content-box
      target.addClass("active-tab").find(".content-box").fadeIn(300);

      console.log("Target:", target); // Debugging: Check the target tab
      console.log("Content Box:", target.find(".content-box")); // Debugging: Check the content-box
    });
  } // if($('.tabs-box').length){
  // 	$('.tabs-box .tab-buttons .tab-btn').on('click', function(e) {
  // 		e.preventDefault();
...
// const div1 = document.querySelector(".quote-hover");
// const div2 = document.querySelector("#quote-hidden");
